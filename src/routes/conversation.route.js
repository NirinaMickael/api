...
ConvRoute.get('/:senderId/:receiveId', function (req, res) {
    conversation_controller_1.NewConversation(req, res);
});
ConvRoute.get('/:userId', function (req, res) {
    conversation_controller_1.GetAllconversation(req, res);
});
ConvRoute.get('/:userId/:otherId', function (req, res) {
    conversation_controller_1.GetConversation(req, res);
});
